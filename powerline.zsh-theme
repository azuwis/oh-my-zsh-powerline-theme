...
PROMPT="$POWERLINE_SEC1_BG$POWERLINE_SEC1_TXT $POWERLINE_USER_NAME %k%f$POWERLINE_SEC1_FG%K{237}"$'\ue0b0'"%k%f%F{white}%K{237} "$POWERLINE_CURRENT_PATH""$POWERLINE_GIT_INFO_LEFT" %k%F{240}"$'\ue0b0'"%f "
